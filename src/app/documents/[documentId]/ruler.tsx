    ...
    if ((isDraggingLeft || isDraggingRight) && rulerRef.current) {
      ...
      if (container) {
        ...
        if (isDraggingLeft) {
          ...
          setRightMargin(constrainedRightMargin); // TODO : Make Collaborative
        }
      }
    }
  };
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 h-full">
          <div className="realtive h-full w-[816px]">
            {markers.map((marker) => {
...
const Marker = ({
  ...
  return (
    <div
      className="absolute bottom-0 w-4 h-full cursor-ew-resize z-[5] group -ml-2"
      style={{ [isLeft ? "left" : "right"]: `${position}px` }}
      onMouseDown={onMouseDown}
      onDoubleClick={onDoubleClick}
    >
      <FaCaretDown className="absolute left-1/2 top-0 h-full fill-blue-500 transform -translate-x-1/2 text-neutral-500" />
      <div
